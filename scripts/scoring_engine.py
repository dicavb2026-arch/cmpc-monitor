...
try:
    ...
    pd.DataFrame(columns=["predio", "comuna", "latitud", "longitud", "score", "nivel"]).to_csv("data/estado_predios.csv", index=False)
    print("⚠️ Archivos base no encontrados.")
    exit()
